...
\author{\IEEEauthorblockN{
    ...
    Vincent Lorentz\textsuperscript{2}, 
    Marcello Lobo Heldwein\textsuperscript{3}
}
\IEEEauthorblockA{1 Fraunhofer Institute for Integrated Systems and Device Technology IISB, Erlangen, Germany}
\IEEEauthorblockA{2 Chair of Electronics for Electrical Energy Storage, University of Bayreuth, Germany}
\IEEEauthorblockA{3 Chair of High-Power Converter Systems, Technical University of Munich, Germany}
}
