...
\begin{equation}
    \begin{bmatrix} v_\mathrm a \\ v_\mathrm b \end{bmatrix} = \begin{bmatrix} \sbl{Lm}+\sbl{Lout} & -\sbl{Lm}+\sbl{Lout} \\ \sbl{Lm}+\sbl{Lout} & \sbl{Lm}+\sbl{Lout} \end{bmatrix} \begin{bmatrix} \frac{d\sbl{i1}}{dt}  \\ \frac{d\sbl{i2}}{dt} \end{bmatrix}
\end{equation}
Comparing the coefficients proves that both models are identical for
\begin{equation}
